            ...
            <div class="p-5">
                ...
                <div class="flex items-center gap-4 mb-4">
                    <div class="w-12 h-12 rounded-xl bg-blue-50 flex items-center justify-center border border-blue-100 shrink-0">
                            <img src="/assets/images/icloud.webp" alt="iCloud" class="w-7 h-7 object-contain">
                    </div>
                    <div>
                ...
                <div class="mb-5">
                        ...
                        <span class="text-xs text-gray-400 line-through decoration-red-400 decoration-2">${formatCurrency(yearly.normalPrice)}</span>
                ...
                <div class="space-y-2 mb-5">
                    <div class="flex items-center gap-2 text-sm text-gray-700">
                        ...
                        <span>2TB iCloud Storage</span>
                    </div>
                    <div class="flex items-center gap-2 text-sm text-gray-700">
                        <i class="fas fa-check-circle text-blue-500"></i>
                        <span>Apple One Premier</span>
                    </div>
                    <div class="flex items-center gap-2 text-sm text-gray-700">
                        <i class="fas fa-check-circle text-blue-500"></i>
                        <span>Apple Music & TV+</span>
                    </div>
                </div>
