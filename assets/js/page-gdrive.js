                ...
                <div class="p-6">
                    ...
                    <div class="flex flex-col items-center text-center mb-6">
                        <div class="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-50 to-white border border-blue-100 flex items-center justify-center shadow-sm mb-3">
                             <img src="/assets/images/gdrive.png" alt="Google Drive" class="w-10 h-10 object-contain">
                        </div>
                        <h3 class="text-xl font-black text-gray-900 leading-tight">Google Drive 2TB</h3>
                        <p class="text-sm text-gray-500 font-medium">Lifetime License • Private</p>
                    </div>
                    ...
                    <div class="text-center mb-6">
                         ...
                         <div class="flex items-center justify-center gap-2 mt-2">
                            <span class="text-sm text-gray-400 line-through decoration-red-400 decoration-2">${formatCurrency(lifetime.normalPrice)}</span>
                    ...
                    <div class="grid grid-cols-2 gap-3 mb-6">
                        <div class="bg-gray-50 p-3 rounded-xl border border-gray-100 text-center">
                            <i class="fas fa-hdd text-blue-600 text-lg mb-1"></i>
                        ...
                        <div class="bg-gray-50 p-3 rounded-xl border border-gray-100 text-center">
                            <i class="fas fa-lock text-orange-600 text-lg mb-1"></i>
