...
// -- ULTIMATE CONFIG ------------------------------------------
const VISITOR_RANGE = { min: 52, max: 94 };
const WA_NUMBER = '6285602152097';
const WA_PRODUCT_NAME = 'Netflix Premium';
const FLASH_BAR_LABEL = '?? Promo Netflix Premium Berakhir dalam';
const TOAST_MESSAGES = [
    { name: 'Rina A.', msg: 'Baru langganan Netflix Premium 1 Tahun ??' },
    { name: 'Dodi P.', msg: 'Akun Netflix sudah aktif, nonton langsung!' },
    { name: 'Sinta W.', msg: 'Worth it banget, 4K jernih!' },
    { name: 'Budi S.', msg: 'Proses cepat, 5 menit langsung bisa nonton.' },
    { name: 'Maya D.', msg: 'Repeat order ke-3 kali, tetap mantap!' },
    { name: 'Agung R.', msg: 'Anti hold, recommended banget!' },
    { name: 'Fajar N.', msg: 'Harga terjangkau, kualitas premium!' },
    { name: 'Wulan S.', msg: 'Seller fast respons, amanah.' },
    { name: 'Tono J.', msg: 'Garansi beneran, bukan asal ngomong.' },
    { name: 'Putri L.', msg: 'Download offline lancar, suka banget!' }
];
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Track FB InitiateCheckout when form is visible
    trackFBEvent('ViewContent', { content_name: 'Netflix Premium', content_category: 'Streaming' });
});
        ...
        <article class="relative overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
            ...
            <div class="bg-gradient-to-br from-red-50 via-white to-red-50 p-4 pb-3 border-b border-gray-100">
                ...
                <p class="text-[13px] text-gray-600 font-medium flex items-center gap-1">
                    ...
                    Private Account &bull; 4K UHD &bull; Anti Hold
                </p>
            </div>
