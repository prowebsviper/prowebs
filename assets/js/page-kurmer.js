...
// -- ULTIMATE CONFIG ------------------------------------------
const VISITOR_RANGE = { min: 63, max: 118 };
const WA_NUMBER = '6285602152097';
const WA_PRODUCT_NAME = 'Perangkat Ajar Deep Learning';
const FLASH_BAR_LABEL = '?? Promo Perangkat Ajar Berakhir dalam';
const TOAST_MESSAGES = [
    { name: 'Bu Rina G.', msg: 'Modul Ajar Deep Learning langsung jadi! ??' },
    { name: 'Pak Budi H.', msg: 'Lengkap, ATP, LKPD, Asesmen semua ada.' },
    { name: 'Bu Sari W.', msg: 'Hemat waktu persiapan mengajar banget!' },
    { name: 'Pak Eko N.', msg: 'Format Word, mudah diedit sesuai kondisi kelas.' },
    { name: 'Bu Maya K.', msg: 'Sesuai Kurikulum Nasional terbaru!' },
    { name: 'Pak Dodi S.', msg: 'Pengiriman otomatis ke WA & Email.' },
    { name: 'Bu Putri L.', msg: 'Garansi file pasti sampai, amanah!' },
    { name: 'Pak Agus R.', msg: 'Repeat beli setiap tahun ajaran.' },
    { name: 'Bu Wulan D.', msg: 'Sangat membantu guru baru!' },
    { name: 'Pak Hendra M.', msg: 'Worth it, harga terjangkau kualitas oke.' }
];
const EXIT_POPUP_CONFIG = {
    title: '?? Perangkat Ajar Deep Learning Siap Kirim!',
    desc: 'Mulai Rp 50.000 per mata pelajaran. Hemat waktu persiapan mengajar!',
    badge: '? KURIKULUM NASIONAL 2026',
    cta: 'Oke, Lihat Paketnya!'
};
// -------------------------------------------------------------
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    trackFBEvent('ViewContent', { content_name: 'Perangkat Ajar', content_category: 'Education' });
            ...
            <div class="px-4 pb-4">
                <div class="flex gap-2">
                    ...
                    <button id="btnDetail" type="button"
                        class="h-12 w-12 rounded-xl border-2 border-gray-200 bg-white text-gray-600 flex items-center justify-center active:scale-[0.95] hover:bg-gray-50 hover:border-blue-200 transition-all"
