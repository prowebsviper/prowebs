...
// -- ULTIMATE CONFIG ------------------------------------------
const VISITOR_RANGE = { min: 38, max: 71 };
const WA_NUMBER = '6285602152097';
const WA_PRODUCT_NAME = 'Adobe Creative Cloud';
const FLASH_BAR_LABEL = '?? Promo Adobe CC Berakhir dalam';
const TOAST_MESSAGES = [
    { name: 'Agus P.', msg: 'Baru aktifkan Adobe CC All Apps 1 Tahun! ??' },
    { name: 'Rina K.', msg: 'Photoshop & Illustrator lancar, recommended!' },
    { name: 'Doni S.', msg: 'Tahun kedua langganan disini, tetap oke!' },
    { name: 'Sari W.', msg: 'Hemat banget vs beli langsung di Adobe!' },
    { name: 'Eko S.', msg: 'AI Firefly beneran jalan, keren!' },
    { name: 'Dewi L.', msg: 'Proses 5 menit langsung bisa pakai!' },
    { name: 'Hendra W.', msg: 'Garansi jelas, seller terpercaya.' },
    { name: 'Maya P.', msg: 'Buat mahasiswa desain, solusi terbaik!' },
    { name: 'Rizky R.', msg: 'Update otomatis berjalan normal!' },
    { name: 'Putri A.', msg: 'Rekomen ke semua teman kantor ??' }
];
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    updateTotalPrice();
    if (typeof renderOfferHeaderLayout === 'function') renderOfferHeaderLayout();
    initNotifications();
    ...
    trackFBEvent('ViewContent', { content_name: 'Adobe Creative Cloud', content_category: 'Software' });
});
...
function renderPackageCards() {
    ...
    const btnClassBase = "flex-1 py-2.5 text-xs font-semibold rounded-lg transition-all duration-200";
