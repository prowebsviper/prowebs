...
function renderPackageCards() {
    ...
    container.innerHTML = `
        ...
        <article class="relative overflow-hidden rounded-3xl bg-white shadow-xl ring-1 ring-gray-900/5 transition-all hover:shadow-2xl">
            <!-- Header: Solid Color -->
            <div class="bg-[#D83B01] p-6 text-white relative overflow-hidden">
                ...
                <div class="relative z-10 flex items-start justify-between">
                    <div>
                        ...
                        <h3 class="mt-3 text-2xl font-black tracking-tight text-white leading-tight">Microsoft Office 365</h3>
                        <p class="mt-1 text-sm font-medium text-white/90 flex items-center gap-1.5">
                            <i class="fas fa-check-circle"></i> Lifetime License + 5TB OneDrive
                        </p>
                    </div>
                    <!-- Discount Badge -->
            ...
            <div class="p-6">
                <div class="flex items-end gap-2 mb-1">
                    <span class="text-4xl font-black text-gray-900 tracking-tight">${formatCurrency(lifetime.price)}</span>
                    <span class="text-lg font-bold text-gray-400 line-through mb-1.5 decoration-2">${formatCurrency(lifetime.normalPrice)}</span>
                </div>
                <p class="text-xs font-semibold text-orange-700 bg-orange-50 inline-block px-2 py-1 rounded-md mb-4 border border-orange-100">
                ...
                <div class="grid grid-cols-[1fr_auto] gap-3">
                    <button type="button" onclick="document.getElementById('nama').focus()" class="h-14 rounded-2xl bg-[#D83B01] text-white shadow-lg shadow-orange-200 hover:bg-[#A92E01] active:scale-[0.98] transition-all flex items-center justify-center gap-2 font-bold text-[16px] group">
                        <span>Ambil Promo</span>
                        <i class="fas fa-arrow-right group-hover:translate-x-1 transition-transform"></i>
                    </button>
                    <button id="btnDetail" type="button" class="h-14 w-14 rounded-2xl border-2 border-gray-100 text-gray-400 hover:border-orange-100 hover:bg-orange-50 hover:text-[#D83B01] transition-all flex items-center justify-center">
