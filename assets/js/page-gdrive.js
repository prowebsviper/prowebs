...
// -- ULTIMATE CONFIG ------------------------------------------
const VISITOR_RANGE = { min: 44, max: 82 };
const WA_NUMBER = '6285602152097';
const WA_PRODUCT_NAME = 'Google Drive 2TB Lifetime';
const FLASH_BAR_LABEL = '?? Promo Google Drive 2TB Berakhir dalam';
const TOAST_MESSAGES = [
    { name: 'Budi S.', msg: '5 menit langsung 2TB! Gokil! ??' },
    { name: 'Rina A.', msg: 'Storage lega, foto keluarga aman semua!' },
    { name: 'Dedi K.', msg: 'Beneran seumur hidup, bukan hoax ??' },
    { name: 'Sinta P.', msg: 'Admin ramah, garansi jelas.' },
    { name: 'Agung W.', msg: 'Harga kaki lima kualitas bintang lima!' },
    { name: 'Putri L.', msg: 'Hemat bgt buat mahasiswa.' },
    { name: 'Bayu P.', msg: 'Repeat order, gak pernah kecewa.' },
    { name: 'Eko S.', msg: 'Upload video 4K gas terus!' },
    { name: 'Fajar N.', msg: 'Freelancer butuh storage gede, solusi terbaik.' },
    { name: 'Maya D.', msg: 'Fast response, proses mudah!' }
];
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    trackFBEvent('ViewContent', { content_name: 'Google Drive 2TB', content_category: 'Cloud Storage' });
});
