...
// -- ULTIMATE CONFIG ------------------------------------------
const VISITOR_RANGE = { min: 35, max: 67 };
const WA_NUMBER = '6285602152097';
const WA_PRODUCT_NAME = 'Microsoft Office 365 Lifetime';
const FLASH_BAR_LABEL = '?? Promo Office 365 Berakhir dalam';
const TOAST_MESSAGES = [
    { name: 'Andi S.', msg: 'Office 365 Lifetime, OneDrive 5TB lega!' },
    { name: 'Dewi L.', msg: 'Proses cepat, admin ramah! Recommended.' },
    { name: 'Budi S.', msg: 'Hemat banget vs langganan bulanan!' },
    { name: 'Rina A.', msg: 'Fitur lengkap, bisa collab real-time.' },
    { name: 'Eko P.', msg: 'Kualitas original, semua fitur jalan!' },
    { name: 'Siti N.', msg: 'Dipandu sampai beres, garansi jelas.' },
    { name: 'Fajar S.', msg: 'OneDrive 5TB kepake buat video editing!' },
    { name: 'Gita G.', msg: 'Beli kedua kali, sukses terus!' },
    { name: 'Haryanto.', msg: 'Gak perlu mikir perpanjangan lagi.' },
    { name: 'Indra M.', msg: 'Offline di laptop, login 5 device aman!' }
];
const EXIT_POPUP_CONFIG = {
    title: '?? Tunggu! Office 365 Lifetime Rp 99.000',
    desc: 'Akses penuh Word, Excel, PowerPoint + 5TB OneDrive. Bayar sekali, pakai selamanya!',
    badge: '? PENAWARAN EKSKLUSIF',
    cta: 'Ambil Sekarang!'
};
// -------------------------------------------------------------
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    captureUTM();
    initFlashBar();
    initProgressStepper(1);
    initLiveVisitorCount();
    placeHeaderAtTop();
    initWAFloat();
    initInputMask();
    // -------------------------------------------------------

    trackFBEvent('ViewContent', { content_name: 'Office 365 Lifetime', content_category: 'Software' });
});
                ...
                <div class="flex items-start justify-between mb-2">
                    <div class="flex items-center gap-2">
                        <span class="inline-flex items-center gap-1 rounded-full bg-orange-100 px-2 py-0.5 text-[11px] font-bold text-orange-700">
                            ...
                            Layanan Siap Aktivasi
                        </span>
                    </div>
                    <span class="rounded-md bg-black px-2 py-0.5 text-[10px] font-bold text-white uppercase tracking-wide">Terverifikasi</span>
                </div>
            ...
            <div class="p-4">
                <div class="bg-gradient-to-br from-orange-50 to-red-50 rounded-xl p-3 border border-orange-100">
                    <div class="flex items-center justify-between mb-1">
                        <div>
                            <p class="text-[11px] font-semibold text-gray-500 mb-0.5">Harga Paket Saat Ini</p>
            ...
            <div class="px-4 pb-4">
                <div class="flex gap-2">
                    ...
                    <button id="btnDetail" type="button"
                        class="h-12 w-12 rounded-xl border-2 border-gray-200 bg-white text-gray-600 flex items-center justify-center active:scale-[0.95] hover:bg-gray-50 hover:border-orange-200 transition-all"
                ...
                <p class="mt-2.5 text-center text-[11px] text-gray-500 flex items-center justify-center gap-1">
                    ...
                    <span class="font-medium">Garansi uang kembali sesuai ketentuan</span>
                </p>
            </div>
        </article>
    `;
