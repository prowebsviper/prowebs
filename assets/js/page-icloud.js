...
// -- ULTIMATE CONFIG ------------------------------------------
const VISITOR_RANGE = { min: 41, max: 78 };
const WA_NUMBER = '6285602152097';
const WA_PRODUCT_NAME = 'iCloud+ 2TB';
const FLASH_BAR_LABEL = '?? Promo iCloud+ 2TB Berakhir dalam';
const TOAST_MESSAGES = [
    { name: 'Anita W.', msg: 'Notif Storage Full hilang selamanya! ??' },
    { name: 'Budi S.', msg: 'Legal dan aman, admin fast response!' },
    { name: 'Citra L.', msg: 'Bisa share sama keluarga, mantap!' },
    { name: 'Dimas P.', msg: 'Upload video 4K lancar jaya.' },
    { name: 'Eka P.', msg: 'Work 100% di iPhone & iPad.' },
    { name: 'Fajar N.', msg: 'Harga hemat, manfaat besar!' },
    { name: 'Gita P.', msg: 'Proses cepat, garansi jelas!' },
    { name: 'Hendra S.', msg: 'Udah langganan, gapernah kecewa.' },
    { name: 'Indah S.', msg: 'Foto anak aman tersimpan semua.' },
    { name: 'Joko R.', msg: 'Sinkronisasi antar device Apple mulus.' }
];
const EXIT_POPUP_CONFIG = {
    title: '?? Eh, Jangan Pergi Dulu!',
    desc: 'iCloud+ 2TB cuma Rp 350.000/tahun â€” harga Apple official di atas Rp 2 juta!',
    badge: '? HARGA SPESIAL',
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    trackFBEvent('ViewContent', { content_name: 'iCloud+ 2TB', content_category: 'Cloud Storage' });
});
