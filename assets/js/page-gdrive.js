            ...
            <div class="bg-[#1a73e8] p-6 text-white relative overflow-hidden">
                ...
                <div class="relative z-10 flex items-start justify-between">
                    <div>
                        ...
                        <h3 class="mt-3 text-2xl font-black tracking-tight text-white leading-tight">Google Drive 2TB</h3>
                        <p class="mt-1 text-sm font-medium text-white/90 flex items-center gap-1.5">
                            <i class="fas fa-check-circle"></i> Original Lifetime License
                        </p>
                    </div>
                    <!-- Discount Badge -->
            ...
            <div class="p-6">
                ...
                <div class="rounded-xl bg-orange-50 p-3 border border-orange-100 mb-5">
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <span class="text-xs font-bold text-gray-900">92% Terjual</span>
                    </div>
                ...
                <div class="grid grid-cols-[1fr_auto] gap-3">
                    <button type="button" onclick="document.getElementById('nama').focus()" class="h-14 rounded-2xl bg-[#1a73e8] text-white shadow-lg shadow-blue-200 hover:bg-[#1557b0] active:scale-[0.98] transition-all flex items-center justify-center gap-2 font-bold text-[16px] group">
